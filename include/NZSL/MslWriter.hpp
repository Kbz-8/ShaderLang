...
#ifndef NZSL_MSLWRITER_HPP
#define NZSL_MSLWRITER_HPP
...
namespace nzsl
{
	class NZSL_API MslWriter : Ast::ExpressionVisitorExcept, Ast::StatementVisitorExcept
	{
		public:
			struct Environment;

			inline MslWriter();
			MslWriter(const MslWriter&) = delete;
...
#include <NZSL/MslWriter.inl>

#endif // NZSL_MSLWRITER_HPP
